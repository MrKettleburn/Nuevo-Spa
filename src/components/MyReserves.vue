...
<template>
    ...
    <div class="container-fluid p-0">
        ...
        <h1 class="mb-4 text-center" >All Reserves</h1>
    ...
    <DataTable :value="customers"  rowGroupMode="rowspan" groupRowsBy="name" sortMode="single" sortField="name" :sortOrder="1" class="custom-datatable p-datatable p-datatable-bordered p-datatable-hoverable table-bordered" showGridlines tableStyle="min-width: 50rem "  :style="datatableStyle" scrollable scrollHeight="400px">
        ...
        <Column field="precio" header="Pricing" style="min-width: 150px">
            <template #body="slotProps">
                <div class="flex items-center gap-2">
                     <span>{{ slotProps.data.precio }}</span>
                </div>
            </template>
        </Column>
        <Column field="especialista" header="Specialist" style="min-width: 150px">
            <template #body="slotProps">
                <div class="flex items-center gap-2">
                     <span>{{ slotProps.data.especialista }}</span>
                </div>
            </template>
        </Column>
    ...
    <div style="display: flex;  justify-content: right; margin-right: 43px; margin-bottom: 5px; padding-top: 0px;">
        <Button class="buton" style="margin: 4px ; border-color:indianred; color: black" label="Add Reserve" ></Button>
        <Button class="buton" style="margin: 4px ; border-color:indianred; color: black " label="Cancel Reserve" ></Button>
    </div>
